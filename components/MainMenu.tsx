...
async function fetchWithQuickAuth(url: string, init?: RequestInit) {
  try {
    ...
    // Preview / non-farcaster: token yok → normal fetch dene (API 401 dönerse UI defaults kalır)
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Admin shortcut (sadece admin ise) */}
        {isAdmin && onAdmin && (
          <button
            onClick={onAdmin}
            style={{
        ...
        >
          ...
          <div
            style={{
              ...
              borderRadius: '16px',
              padding: '18px',     // ✅ diğerleriyle aynı
              textAlign: 'left',   // ✅ kart hissi aynı
            }}
          >
